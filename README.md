# Korean Public APIs — 설치 가능한 AI 스킬
...
- [스킬 폴더](skills/korean-public-apis) · [스킬 전용 ZIP 다운로드](https://github.com/contentriumkorea/public-apis-4Kr/releases)
...
| [ITS 국가교통정보센터 Open Data API](https://www.its.go.kr/opendata/)                          | 전국 교통소통, 돌발상황, CCTV, 교통예측, VDS·VMS 등 국가 교통정보 제공 | `apiKey` |
